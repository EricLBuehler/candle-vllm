//! Conversation management for chat templates and tool calling.
//!
//! This module provides conversation management functionality, including:
//! - Chat template rendering
//! - Multi-turn conversation tracking
//! - Tool call/response message handling
...
use candle_vllm_core::openai::requests::{Tool, ToolCall};
...
mod tests {
    use super::*;
    use candle_vllm_core::openai::requests::{FunctionCall, FunctionDefinition};
