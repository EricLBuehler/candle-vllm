...
//! LLM-specific extensions for candle-vllm.
//!
//! Note: We use the prometheus_parking_lot primitives for capacity tracking
//! and queue management, but define a custom TaskExecutor trait because
//! LLM streaming results contain channels that cannot be serialized.
...
///
/// This is a simplified version of prometheus_parking_lot's TaskMetadata
/// with just the fields we need for LLM inference scheduling.
