...
pub trait AttentionBiasBlockDiagonal {
    ...
    fn make_local_attention(
        ...
        Err(APIError::new_str("make_local_attention not implemented for default trait implementation"))
    }
}
...
impl AttentionBiasBlockDiagonal for LowerTriangularMaskWithTensorBias {
    ...
    fn _create_block_mask(
        ...
        Err(APIError::new_str("_create_block_mask should not be called for LowerTriangularMaskWithTensorBias"))
    }
    fn get_k_seqinfo(&self) -> &SeqLenInfo {
        panic!("get_k_seqinfo should not be called for LowerTriangularMaskWithTensorBias")
    }
    fn get_q_seqinfo(&self) -> &SeqLenInfo {
        panic!("get_q_seqinfo should not be called for LowerTriangularMaskWithTensorBias")
    }
    fn make_local_attention(
        &self,
        _window_size: usize,
    ) -> Result<Box<dyn AttentionBiasBlockDiagonal>, APIError> {
        Err(APIError::new_str("make_local_attention should not be called for LowerTriangularMaskWithTensorBias"))
    }
}
