...
#[cfg(any(feature = "flash", feature = "flashattn", feature = "flashinfer"))] // If a fused attention backend is enabled, the backend owns masking.
...
#[cfg(not(any(feature = "flash", feature = "flashattn", feature = "flashinfer")))]
