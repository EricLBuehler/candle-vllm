...
impl Gemma2Config {
    pub fn into_config(
        ...
        Config {
            ...
            eos_token_id: super::TokenID(Either::Right(Some(self.eos_token_id))),
            ...
            query_pre_attn_scalar: Some(self.query_pre_attn_scalar),
        }
    }
}
...
impl Attention {
    fn new(rotary_emb: Arc<RotaryEmbedding>, cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let head_dim = cfg.get_head_size();
        ...
        let query_pre_attn_scalar = cfg
            ...
            .expect("Gemma 2 config must have `query_pre_attn_scalar`");
        // FIXME: We don't correctly handle the sliding window attention.
        // https://github.com/vllm-project/vllm/blob/b74a12580022039fc15fb54c7066cc13fdc96220/vllm/model_executor/models/gemma2.py#L141-L146
        Ok(Self {
            q_proj,
            k_proj,
            v_proj,
            ...
            attn: PagedAttention::new(
                ...
                head_dim,
                1. / ((query_pre_attn_scalar as f32).sqrt()),
...
impl Gemma2 {
    ...
    pub fn forward(
        ...
        if let Some(final_logit_softcapping) = self.cfg.final_logit_softcapping {
